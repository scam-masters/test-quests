...
class TestScoreboard:
    def test_user_50(self, driver, user_50_points):
        score = driver.find_element(By.XPATH, f"//tr/td[text() = '{user_50_points[1]}']/../td[2]")
        assert(score.text == '50')

    def test_user_0(self, driver, user_0_points):
        score = driver.find_element(By.XPATH, f"//tr/td[text() = '{user_0_points[1]}']/../td[2]")
        assert(score.text == '0')
    ...
    def test_order_scoreboard(self, driver, user_50_points, user_0_points):
        ...
        driver.find_element(By.XPATH,
                            f"//tr/td[text() = '{user_50_points[1]}']/../following-sibling::tr//td[text() = '{user_0_points[1]}']")
